<?php
    // see overview video ~12:00
    /*
        This is the file that JS will contact via AJAX with an asynchronous
        technique that built into JS that will allow us to ask update.php for
        more info. So basically JS will call this file whenever the user drags
        the map or performs a search that jumpms the user to another location.
